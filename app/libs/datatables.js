 ...
 *   https://datatables.net/download/#bs4-4.1.1/dt-1.10.20/e-1.9.2/rr-1.2.6
 *
 * Included libraries:
 *   Bootstrap 4 4.1.1, DataTables 1.10.20, Editor 1.9.2, RowReorder 1.2.6
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4-4.1.1/dt-1.10.20/e-1.9.2/rr-1.2.6",
